...
class Employee(BaseModel):
    ...
    employee_id = models.CharField(
        max_length=20, unique=True, verbose_name=_("ID de Empleado")
    )
    ...
    hire_date = models.DateField(verbose_name=_("Fecha de Contratación"))
    ...
    emergency_contact = models.CharField(
        max_length=100, blank=True, verbose_name=_("Contacto de Emergencia")
    )
    emergency_phone = models.CharField(
        max_length=20, blank=True, verbose_name=_("Teléfono de Emergencia")
    )
    skills = models.JSONField(default=list, blank=True, verbose_name=_("Habilidades"))
    certifications = models.JSONField(
        default=list, blank=True, verbose_name=_("Certificaciones")
    )
...
class WorkSchedule(BaseModel):
    ...
    break_start = models.TimeField(
        null=True, blank=True, verbose_name=_("Inicio de Descanso")
    )
    break_end = models.TimeField(
        null=True, blank=True, verbose_name=_("Fin de Descanso")
    )
