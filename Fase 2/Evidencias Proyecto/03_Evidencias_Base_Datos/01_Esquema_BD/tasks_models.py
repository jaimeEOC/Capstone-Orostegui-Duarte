...
class TaskTimeLog(BaseModel):
    ...
    end_time = models.DateTimeField(
        null=True, blank=True, verbose_name=_("Hora de Fin")
    )
    description = models.TextField(
        blank=True, verbose_name=_("Descripción del Trabajo")
    )
...
class TaskComment(BaseModel):
    ...
    task = models.ForeignKey(
        Task, on_delete=models.CASCADE, related_name="comments", verbose_name=_("Tarea")
    )
