"""
Configuración del proyecto Logistica HR para SQLite (Desarrollo en Windows)
...
ROOT_URLCONF = 'logistica_hr.urls'
...
WSGI_APPLICATION = 'logistica_hr.wsgi.application'

# Database - SQLite para desarrollo en Windows
DATABASES = {
    'default': {
