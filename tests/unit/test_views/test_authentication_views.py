...
class TestLoginView:
    ...
    def test_supervisor_login_redirects_to_supervisor_dashboard(self):
        ...
        response = self.client.post(
            self.login_url,
            {"username": supervisor_user.username, "password": "MySecurePass123!"},
        )
    ...
    def test_employee_login_redirects_to_employee_dashboard(self):
        ...
        response = self.client.post(
            self.login_url,
            {"username": employee_user.username, "password": "MySecurePass123!"},
        )
    ...
    def test_invalid_credentials_shows_error(self):
        ...
        response = self.client.post(
            self.login_url,
            {"username": "usuario_inexistente", "password": "password_incorrecto"},
        )
    ...
    def test_inactive_user_cannot_login(self):
        ...
        response = self.client.post(
            self.login_url,
            {"username": admin_user.username, "password": "MySecurePass123!"},
        )
...
class TestRegistrationView:
    ...
    def test_duplicate_username_shows_error(self):
        """Probar que username duplicado muestra error"""
        # Crear usuario existente
        existing_user = AdminUserFactory(username="usuario_existente")

        user_data = {
            "username": "usuario_existente",  # Duplicado
            "email": "nuevo@test.com",
            "first_name": "Juan",
            "last_name": "Pérez",
            "role": "employee",
